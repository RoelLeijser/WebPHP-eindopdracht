        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900 dark:text-gray-100">
                    <div class="py-3">
                        <form method="GET" class="flex flex-row justify-between" action="#">
                            <div class="flex w-80">
                                <input placeholder="{{__('general.search')}}" name="search" value="{{ request('search') }}" type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                            ...
                            <div class="flex">
                                <select name="role"  class="w-full appearance-none bg-white block border border-gray-400 focus:outline-none focus:shadow-outline hover:border-gray-500 leading-tight pr-10 px-4 py-2 rounded shadow w-40" onchange="this.form.submit()">
                        ...
                        <table class="w-full text-center text-lg text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead class="text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <p>{{ __('account.name') }}</p>
                                    <a href="{{ route('account.index', ['sort' => $nextSort, 'search' => request('search'), 'role' => request('role')]) }}"><svg class="w-3 h-7 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
