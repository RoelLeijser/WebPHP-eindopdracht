    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <a href="{{ route('advertisements.create') }}" class="bg-blue-500 dark:bg-blue-600 hover:bg-blue-700 dark:hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">Create Advertisement</a>
                </div>
            </div>
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex flex-col gap-4">
                ...
                <div class="flex">
                    ...
                    <a href="{{ route('advertisements.index') }}" class="text-blue-500 dark:text-blue-400 hover:underline w-full max-w-40 p-3 whitespace-nowrap">
