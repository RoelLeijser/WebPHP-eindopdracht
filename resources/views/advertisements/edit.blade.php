                ...
                <form action="{{ route('advertisements.update', $advertisement->id) }}" method="POST"
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input dusk="price" type="text" name="price" id="price"
                                class="p-2 border border-gray-300 dark:border-gray-700 rounded-lg"
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <select dusk="delivery" name="delivery" id="delivery"
                                ...
                                <option value="pickup_shipping"
                                    {{ $advertisement->delivery === 'pickup_shipping' ? 'selected' : '' }}>
                                    {{ __('advertisement.pickup_and_shipping') }}</option>
                                <option value="shipping"
                                    {{ $advertisement->delivery === 'shipping' ? 'selected' : '' }}>
                            ...
                            <button dusk="update" type="submit"
                                class="bg-blue-500 dark:bg-blue-600 hover:bg-blue-700 dark:hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">{{ __('advertisement.update_advertisement') }}</button>
                        </div>
                </form>
            </div>
        </div>
